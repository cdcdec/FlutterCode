...
class ProvincesBloc extends BaseBloc {
  ...
  Future<List<ProvinceModel>> requestAllProvinces() async {
    var resp = await Application.http.getRequest(WeatherApi.WEATHER_PROVINCE, error: (msg) => _logger.log(msg, 'province'),state:(state){
      _logger.log(state.toString(),"province");
    });
